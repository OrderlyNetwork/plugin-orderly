...
export function getEvmVaultAddress(chainId: SupportedEvmChain): Address {
  return match(chainId)
    ...
    .with("arbitrumSepolia", () => "0x0EaC556c0C2321BA25b9DC01e4e3c95aD5CDCd2f")
    .with("optimismSepolia", () => "0xEfF2896077B6ff95379EfA89Ff903598190805EC")
    ...
    .with("avalancheFuji", () => "0xAB6c8F6245B67421302AAe30AcEB10E00c30F463")
...
export function getEvmUSDCAddress(chain: SupportedEvmChain): Address {
  return match(chain)
    ...
    .with("arbitrumSepolia", () => "0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d")
    .with("optimismSepolia", () => "0x5fd84259d66Cd46123540766Be93DFE6D43130D7")
    ...
    .with("avalancheFuji", () => "0x5425890298aed601595a70ab815c96711a31bc65")
    .exhaustive() as Address;
}
...
export async function withdrawUSDCFromOrderly(
  ...
  const [message, signature, address] = await match(chainMode)
    ...
    .with("solana", async () => {
      ...
      return [withdrawMessage.message, withdrawMessage.signatured, address];
    })
    .exhaustive();
...
export async function settlePnlFromOrderly(
  ...
  const [message, signature, address] = await match(chainMode)
    ...
    .with("solana", async () => {
      ...
      return [settlePnlMessage.message, settlePnlMessage.signatured, address];
    })
    .exhaustive();
